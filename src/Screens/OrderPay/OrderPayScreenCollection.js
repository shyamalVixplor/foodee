...
const OrderPayScreenCollection = ({ navigation, route }) => {
      ...
      .then(response => {
        ...
        if (response.error == false) {
         ...
         // console.log('newTimeArray', newTimeArray);
          ...
          //setTimeChoosed(newTimeArray[0].time);  
           ...
           <TouchableOpacity
            ...
            <View
              style={{
                ...
                borderColor: isStandTime?constant.BgPrimary:'grey',
 ...
 {OrderData[0].pickup_time_min}-{OrderData[0].pickup_time_max} min(s)
            ...
            <View
              style={{
                ...
                <Text
                  ...
                  {isStandTime?'Choose Collection Time':TimeChoosed}
                </Text>
              </View>
              </TouchableOpacity>
          ...
          <View
            ...
            {cashStatus === true ? (
              ...
              //AlertOccurred('Alert','Please Choose a pickup/delivery time4!','ok',);return;
...
export default OrderPayScreenCollection;
